-- Create the email_notification_templates table
...
ON public.email_notification_templates FOR SELECT USING (true);

-- Insert the initial Meme Supreme OTC login template
INSERT INTO public.email_notification_templates (template_type, subject, body_html, body_text)
VALUES (
    'auth_otc',
    'Your Meme Supreme Login Code',
    '<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Meme Supreme Login</title>
    <style>
...
<body>
    ...
    'Your Meme Supreme Login Code is: {{otc}}. This code expires in 5 minutes. If you did not request this, you can safely ignore this email.'
)
